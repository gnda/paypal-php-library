...
$GetVerifiedStatusFields = array(
                            'AccountIdentifierEmailAddress' => 'sandbo_1204199080_biz@angelleye.com',                             // must be present if the emailAddress field below is not) The identifier of the PayPal account holder. The email address of the PayPal account holder. Use this emailAddress field for new integrations.
                            ...
                            'AccountIdentifierAccountId' => 'E7BTGVXBFSUAU',                                // must be present if the emailAddress field below is not) The identifier of the PayPal account holder. The account Id of the PayPal account holder.
