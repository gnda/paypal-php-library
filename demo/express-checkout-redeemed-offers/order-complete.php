    ...
    ?>
      ...
      <div class="row clearfix">
        <div class="col-md-4 column">
          ...
          <p>
             <?php 
                if(isset($_SESSION['wallet_type_0'])){
                    $n=0;
                    while(isset($_SESSION['wallet_type_'.$n])){
                        echo "<strong>WALLET TYPE</strong>  ".$_SESSION['wallet_type_'.$n]."<br>";
                        echo "<strong>WALLET ID</strong>  ".$_SESSION['wallet_id_'.$n]."<br>";
                        echo "<strong>WALLET DESCRIPTION</strong>  ".$_SESSION['wallet_desc_'.$n]."<br>";
                        $n++;
                    }
                }
             ?> 
