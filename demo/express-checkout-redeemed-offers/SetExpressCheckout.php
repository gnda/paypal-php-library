...
$SECFields = array(
					...
					'returnurl' => $domain . 'demo/express-checkout-redeemed-offers/GetExpressCheckoutDetails.php', 							    // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
					'cancelurl' => $domain . 'demo/express-checkout-redeemed-offers/', 							    // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
